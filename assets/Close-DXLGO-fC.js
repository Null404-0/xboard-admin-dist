import{aD as B,aw as $,as as A,ax as b,f as v,d as t,m as l,h as a,H as p,s as T,t as z,i as c,aK as P}from"./index-D3mJvsWQ.js";import{j as m}from"./Button-B8eUBVyN.js";var j="[object Symbol]";function I(e){return typeof e=="symbol"||B(e)&&$(e)==j}function F(e,o){for(var r=-1,i=e==null?0:e.length,n=Array(i);++r<i;)n[r]=o(e[r],r,e);return n}var g=b?b.prototype:void 0,h=g?g.toString:void 0;function y(e){if(typeof e=="string")return e;if(A(e))return F(e,y)+"";if(I(e))return h?h.call(e):"";var o=e+"";return o=="0"&&1/e==-1/0?"-0":o}function H(e){return e==null?"":y(e)}function N(e,o,r){var i=-1,n=e.length;o<0&&(o=-o>n?0:n+o),r=r>n?n:r,r<0&&(r+=n),n=o>r?0:r-o>>>0,o>>>=0;for(var s=Array(n);++i<n;)s[i]=e[i+o];return s}function O(e,o,r){var i=e.length;return r=r===void 0?i:r,!o&&r>=i?e:N(e,o,r)}var D="\\ud800-\\udfff",U="\\u0300-\\u036f",q="\\ufe20-\\ufe2f",E="\\u20d0-\\u20ff",J=U+q+E,V="\\ufe0e\\ufe0f",Z="\\u200d",K=RegExp("["+Z+D+J+V+"]");function C(e){return K.test(e)}function W(e){return e.split("")}var S="\\ud800-\\udfff",_="\\u0300-\\u036f",G="\\ufe20-\\ufe2f",X="\\u20d0-\\u20ff",Y=_+G+X,Q="\\ufe0e\\ufe0f",ee="["+S+"]",d="["+Y+"]",f="\\ud83c[\\udffb-\\udfff]",oe="(?:"+d+"|"+f+")",k="[^"+S+"]",w="(?:\\ud83c[\\udde6-\\uddff]){2}",x="[\\ud800-\\udbff][\\udc00-\\udfff]",re="\\u200d",R=oe+"?",L="["+Q+"]?",ne="(?:"+re+"(?:"+[k,w,x].join("|")+")"+L+R+")*",ie=L+R+ne,se="(?:"+[k+d+"?",d,w,x,ee].join("|")+")",ae=RegExp(f+"(?="+f+")|"+se+ie,"g");function te(e){return e.match(ae)||[]}function le(e){return C(e)?te(e):W(e)}function ue(e){return function(o){o=H(o);var r=C(o)?le(o):void 0,i=r?r[0]:o.charAt(0),n=r?O(r,1).join(""):o.slice(1);return i[e]()+n}}var ce=ue("toUpperCase");const de=v("base-icon",`
 height: 1em;
 width: 1em;
 line-height: 1em;
 text-align: center;
